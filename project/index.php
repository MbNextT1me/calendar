...
<head>
   ...
   <link rel="stylesheet" href="./src/css/for_index.css" type="text/css" />
...
<body>
	...
	<div class="container">
		...
		<form action="./src/incs/php/main.php?x=4&y=''" method="post">
			<fieldset class="form_fieldset_output">
				...
				<div class="menu">
					<select onchange="window.location.href = this.options[this.selectedIndex].value" id="period">
						...
						<option value="./src/incs/php/main.php?x=1&y=Просроченные">Просроченные задачи</option>
						<option value="./src/incs/php/main.php?x=2&y=Выполненные">Выполненные задачи</option>
					</select>
				...
				<table>
                    ...
                    <?php include './src/incs/cout_form.php';?>
				</table>
			</fieldset>
		</form>
	</div>
